...
export const faqs: FAQ[] = [
  {
    question: 'O que é o Smartpresente?',
    answer:
  ...
  {
    question: '​A plataforma analisa redes sociais?',
    answer:
  ...
  {
    question: 'Como a inteligência artificial escolhe os presentes?',
    answer:
  ...
  {
    question: 'O que é MBTI?',
    answer:
      'O MBTI (Indicador de Tipo Myers-Briggs) é um modelo de personalidade usado no mundo inteiro para entender preferências e comportamentos. Ele classifica as pessoas em 16 tipos de personalidade considerando aspectos como comportamento, preferências, forma de tomar decisões e estilo de interação.',
  },
  {
    question: 'Como o MBTI é usado pelo Smartpresente?',
    answer:
  ...
  {
    question: 'O Smartpresente vende os presentes diretamente?',
    answer:
  ...
  {
    question: 'Como funciona a escolha do presente?',
    answer:
  ...
  {
    question: 'O presenteado pode comprar o presente?',
    answer:
  ...
  {
    question: 'Consigo manter o presente surpresa mesmo na hora da escolha?',
    answer:
  ...
  {
    question: 'O que acontece quando o presentedo escolhe o presente?',
    answer:
